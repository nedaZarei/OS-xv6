...
extern long totalram(void);
extern long freeram(void);
...
int top(uint64 tp) {
    ...
    uint total_mem = totalram();
    uint free_mem = freeram();
    uint used_mem = total_mem - free_mem;
    ...
    //uint free_mem = total_mem - used_mem;
